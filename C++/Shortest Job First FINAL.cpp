...
int main() {
    ...
    });// the sort function work like normal , its just that the lambda function provies the criterio for sorting.

    priority_queue<Process, vector<Process>, CompareBurstTime> readyQueue;//priority_queue<Type, Container, Comparator>
    ...
    double avgWaitingTime = (double)totalWaitingTime / n; //(double) is calle typecasting the variable
